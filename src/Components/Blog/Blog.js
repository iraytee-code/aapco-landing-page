...
<div className='text-2xl sm:text-3xl md:text-4xl font-[700] pb-4'>Our Latest News</div>
<div className='text-gray leading-7 md:w-50 pb-10'>Enthusiastically drive revolutionary opportunities before emerging leadership. Distinctively transform tactical methods of empowerment via resource sucking core.</div>
 </div>
